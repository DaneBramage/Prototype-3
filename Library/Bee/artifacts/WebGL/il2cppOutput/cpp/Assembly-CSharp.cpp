...
IL_0025:
	...
	}
	{
		...
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_11 = __this->___crashSound;
...
{
	{
		...
		__this->___gravityModifier = (2.0f);
		__this->___isOnGround = (bool)1;
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void RepeatBackground_Start_mBC99B8939FC946126F5193638EB14ED609C83444 (RepeatBackground_t24ABC10CBE0AFE082D23DFF014D0128CD52FF46F* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_7 = L_6.___x;
		__this->___repeatWidth = ((float)(((float)il2cpp_codegen_multiply(L_4, L_7))/(2.0f)));
		return;
	}
}
...
{
	{
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_0), (28.0f), (0.0f), (0.0f), NULL);
